...
const LINKEDIN_HREF = "https://www.linkedin.com/in/shubham-chopade/";
const BUTTON_TEXT = "Hire Me";

export const Button = ({ translateX }: { translateX: Number }) => {
  return (
    <ButtonWrapper translateX={translateX}>
      <StyledLink href={LINKEDIN_HREF} target="_blank">
        {BUTTON_TEXT}
        <ButtonArrow />
      </StyledLink>
    </ButtonWrapper>
...
const ButtonWrapper = styled.div<BtnProps>`
  ...
  transform: ${(props) => props.translateX > 99 && "translateX(0px)"};
  margin: auto;
`;
